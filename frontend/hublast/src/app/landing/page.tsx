...
export default function Landing() {
    ...
    useEffect(() => {
        ...
        tl.fromTo(titleRef.current, { opacity: 0, y: 50 }, { opacity: 1, y: 0 })
          .fromTo(subtitleRef.current, { opacity: 0, y: 50 }, { opacity: 1, y: 0 }, "-=0.8")
          .fromTo(subtitleDescRef.current, {opacity: 0, y: 50}, {opacity:1, y: 0}, "-=9")
          .fromTo(buttonRef.current, { opacity: 0, y: 50 }, { opacity: 1, y: 0 }, "-=0.9");
    }, []);
        ...
        <>
            ...
            <main className="flex flex-col items-center min-h-screen scroll-smooth">
                ...
                <section id="start" className="w-full h-screen flex flex-col justify-center items-center text-center md:px-4 px-5 bg-gradient-to-b from-transparent to-neutral-50 dark:to-gray-950 scroll-smooth">
                    ...
                    <p ref={subtitleDescRef} className="opacity-0 text-md md:text-lg dark:text-gray-300 text-gray-400 mb-8 max-w-xl">
