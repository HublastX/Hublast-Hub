...
export default function About() {
    ...
    const cards = [
        {
            icon: <FaUsers size={32} className="dark:text-violet-500 text-violet-600" />,
            title: "Comunidade ativa",
            description:
                "Conecte-se com devs iniciantes e experientes, troque ideias e evolua em grupo.",
        },
        {
            icon: <FaProjectDiagram size={32} className="dark:text-violet-500 text-violet-600" />,
            title: "Projetos reais",
            description:
                "Participe de squads com foco em prática e ganhe experiência colaborando em projetos.",
        },
        {
            icon: <FaLightbulb size={32} className="dark:text-violet-500 text-violet-600" />,
